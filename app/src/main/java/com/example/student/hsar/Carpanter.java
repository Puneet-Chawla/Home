...
public class Carpanter extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_carpanter);
    ...
    public void scheduleCarpenter(View v)
    {
     Intent i=new Intent(this,CarpenterQuestions.class);
        startActivity(i);
    }
    @Override
