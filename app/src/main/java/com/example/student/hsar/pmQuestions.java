...
public class pmQuestions extends AppCompatActivity {
...
DatabaseReference databaseReference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_pm_questions);
        getSupportActionBar().setTitle("Fill in Details");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
databaseReference= FirebaseDatabase.getInstance().getReference("services").child("packers");
    ...
    public void sendingData()
    {
        ...
        PmModel pmModel=new PmModel(Add,Phone,Problem);
        databaseReference.child(id).setValue(pmModel);
