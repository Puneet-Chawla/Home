...
public class FridgeQuestions extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fridge_questions);
        getSupportActionBar().setTitle("Fill in Details");
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        databaseReference= FirebaseDatabase.getInstance().getReference("services").child("refrigerator");
...
// add, String appliance, String phone, String repair
        FridgeModel electricalModel=new FridgeModel(Add,Appliance,Phone,Repair);
